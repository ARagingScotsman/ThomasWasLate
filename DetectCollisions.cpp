...
bool Engine::detectCollisions(PlayableCharacter& character)
{
	...
	for (int x = startX; x < endX; ++x)
		{
			for (int y = startY; y < endY; ++y)
			{
				...
				// Is character collidiing with a regular block?
	...
	// Return whether or not our characters have completed this level
	return reachedGoal;
